...
const App = () => {
  ...
  // Effect for handling SSE notifications (Combined historic and real-time)
  useEffect(() => {
    if (!token) {
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case 'add-location':
        return (
          <AddLocationPage
            ...
            onLocationAdded={handleDataRefresh}
      ...
      case 'deletion-requests':
        return (
          <ApproveDeletionsPage
            setNotification={setNotification}
            handleAuthError={handleAuthError}
            handleItemClick={commonProps.handleItemClick}
          />
        );
      case 'detail':
        if (selectedItem) {
    ...
    <div className="min-h-screen bg-slate-100 dark:bg-gray-900 font-sans antialiased flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-grow md:ml-64 transition-all duration-300">
          <div
            className={`p-4 sm:p-6 transition-opacity duration-200 ${
